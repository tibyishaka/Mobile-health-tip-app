...
class _MentalHealthScreenState extends State<MentalHealthScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<TipProvider>(
        context,
        listen: false,
      ).fetchGeminiTipsForCategory(TipCategory.mentalHealth);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final geminiTips = tipProvider.getGeminiTips(TipCategory.mentalHealth);

    final allTips =
        TipRepository.getAllTips(
            l,
          ).where((t) => t.category == TipCategory.mentalHealth).toList()
          ..addAll(geminiTips);
        ...
        child: Column(
          ...
          children: [
            ...
            if (_searchQuery.isEmpty)
              TrendingCommunityTips(category: 'Mental Health'),

            if (tipProvider.isLoadingGemini(TipCategory.mentalHealth) &&
